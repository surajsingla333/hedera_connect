...
import { sendSmartContract } from '../../../../../../API/src/sendSmartContract/sendSmartContract'

class SendSmartContract extends Component {
    state = {
    ...
    signContractCallTransaction = async (e) => {
        ...
        try {
            ...
            let res = await sendSmartContract(Cookies.get('accountId'), private_key, dataFromWeb.address, dataFromWeb.functionName, dataFromWeb.params, 10000)
...
export default connect(mapStateToProps, mapDispatchToProps)(SendSmartContract)
